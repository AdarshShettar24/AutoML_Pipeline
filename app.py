...
st.markdown("""
    <div class="main-header">
        <h2>⚙️ Smart AutoML Health Dashboard</h2>
        <p>Predict health outcomes using Machine Learning — powered by PyCaret</p>
    </div>
""", unsafe_allow_html=True)
# ================================================================
...
st.sidebar.markdown("### 🤖 AutoML Health Predictor")
st.sidebar.write("Built with Streamlit and PyCaret")
...
# ============== APP TABS ==============
tab1, tab2, tab3 = st.tabs(["📊 Dataset & EDA", "🤖 Model Training", "🔮 Predictions"])

with tab1:
    st.subheader("📂 Upload and Explore Dataset")
...
with tab2:
    ...
    if "df" not in st.session_state:
        st.warning("⚠️ Please upload and explore your dataset first in the previous tab.")
    else:
